...
|
*/
$config['base_url'] = 'http://localhost/tokofauzi/';
// $config['base_url'] = 'http://wtpsdemo.my.id/';
// $config['base_url'] = 'http://192.168.1.95/tokofauzi/';
...
|
*/
$config['encryption_key'] = 'c4ipBY0CukaVbqvlRLEgTM8mDre2oKFfUwIsj';
