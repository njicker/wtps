...
class Products extends MY_Controller
{
    ...
    public function add($id = null)
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            // [START] Generated Code Product
            // Get Count by type
            $count_type = $this->products_model->getCount($data['type']);
            $cnt = 10000 + $count_type + 1;
            $cnt = substr($cnt, 1, 4);
            // Generate Code
            $prefix = "";
            ...
            $data['code'] = $prefix . $cnt;
            // [END] Generated Code Product
        ...
        if ($this->form_validation->run() == true && $this->products_model->addProduct($data, $items, $warehouse_qty, $product_attributes, $photos)) {
            ...
            $this->data['cf2']                 = $this->site->getListProductCF('cf2');
