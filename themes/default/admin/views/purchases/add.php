                    ...
                    ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : '[No Urut]/PO/WTPS/' . getMonth() . "/" . date("Y")), 'class="form-control input-tip" id="poref" readonly'); ?>
                            </div>
                        </div>
