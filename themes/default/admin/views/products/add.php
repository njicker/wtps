        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group all">
                        <?= lang('product_code', 'code') ?>
                        <?= form_input('code', ($_POST['code'] ?? ($product ? $product->code : '')), 'class="form-control' . ($Settings->use_code_for_slug ? ' gen_slug' : '') . '" id="code" readonly') ?>
                        <span class="help-block"><?= lang('you_scan_your_barcode_too') ?></span>
                    </div>

                    <div class="form-group all">
                        <?= lang('slug', 'slug'); ?>
                        <?= form_input('slug', set_value('slug'), 'class="form-control tip" id="slug" required="required" readonly'); ?>
                    </div>
