...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart('sales/add_payment_invoice/' . $inv->id, $attrib); ?>
        <div class="modal-body">
            ...
            ?>
                ...
                <input type="hidden" value="<?php echo $inv->id; ?>" name="invoice_id"/>
            </div>
                                ...
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="amount-paid" type="text" id="amount_1"
                                               value="<?= $this->sma->formatDecimal($inv->total_amount - $inv->total_paid); ?>"
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data === false) {
                            ...
                            var due = <?=$inv->total_amount - $inv->total_paid?>;
                            if (due > data.balance) {
