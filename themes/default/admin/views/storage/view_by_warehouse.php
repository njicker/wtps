...
<div class="box">
    <div class="box-header">
        <h2 class="blue">
            <i class="fa-fw fa fa-building"></i> Stock by Warehouse (<?=$warehouses[$_GET['warehouse_id']]->name?>)
        </h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-6">
                    <div class="table-responsive">
                        <h3 style="font-weight: 600;"><?=$products[$prod->product_id]->code?> - <?=$products[$prod->product_id]->name?></h3>
                        <table id="PRData" class="table table-bordered table-condensed table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                foreach($batch as $bat){ 
                                    if($bat->product_id != $prod->product_id){ continue; }
